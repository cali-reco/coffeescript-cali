var Circle, Command, Evaluate, FuzzySet, Gesture, Helper, Line, List, Polygon, Recognizer, Rectangle, Scribble, Shape, Stroke, Tap, Unknown, Vector, _ref, _ref2, _ref3,
...
Helper = {
  ...
  angle: function(a, b) {
    if ((a instanceof Vector) && (b instanceof Vector)) {
      return Math.atan2(Helper.cross(a, b), Helper.dot(a, b));
    } else {
...
Vector = (function() {
  ...
  function Vector(start, end) {
    ...
    this.__defineGetter__("length", function() {
      return Helper.distance(this.start, this.end);
    });
  }
...
(typeof exports !== "undefined" && exports !== null ? exports : this).Helper = Helper;
...
Scribble = (function(_super) {
  ...
  function Scribble(strokes) {
    var point, s, stroke, _i, _j, _len, _len2, _ref2, _ref3, _ref4;
    ...
    for (_i = 0, _len = strokes.length; _i < _len; _i++) {
      ...
      if (!(stroke instanceof Stroke)) {
        ...
        for (_j = 0, _len2 = stroke.length; _j < _len2; _j++) {
          point = stroke[_j];
          s.push((_ref2 = point.x) != null ? _ref2 : point[0], (_ref3 = point.y) != null ? _ref3 : point[1], (_ref4 = point.time) != null ? _ref4 : point[2]);
        }
        stroke = s;
      }
      this.push(stroke);
  ...
  */
  ...
  Scribble.prototype.getPtsInSmallTri = function() {
    var dx, dy, empty, i, inter, k, m, pt, stroke, tri, x, _, _i, _j, _len, _len2;
        ...
        for (k = 0; k <= 3; k++) {
          if (m[k] !== 0) {
            if (v >= Number.MAX_VALUE) {
              ...
              if (x[k] >= pt.x && (x[k] < (tri[k].x > tri[(k + 1) % 3].x ? tri[k].x : tri[(k + 1) % 3].x))) {
                inter++;
              }
            }
          }
...
(typeof exports !== "undefined" && exports !== null ? exports : this).Command = Command;

(typeof exports !== "undefined" && exports !== null ? exports : this).Tap = Tap;
