...
var Circle, Command, Evaluate, FuzzySet, Gesture, Helper, Line, List, Polygon, Recognizer, Rectangle, Scribble, Shape, Stroke, Tap, Unknown, Vector, _ref, _ref1, _ref2,
...
Scribble = (function(_super) {
  ...
  */
  ...
  Scribble.prototype.getLargestTriangle = function() {
    var area, compRootedTri, finalArea, fipa, fipb, fipc, i, ia, ib, ib0, ic, np, pf0, pf1, pf2, pt, pts, ripa, ripb, ripc, triArea, _i, _j, _k, _l, _len, _m, _ref1, _ref2, _ref3, _ref4;
    pts = this.convexHull;
    ...
    pf1 = ripb;
    pf2 = ripc;
    for (ia = _l = _ref4 = ripa + 1; _ref4 <= ripb ? _l <= ripb : _l >= ripb; ia = _ref4 <= ripb ? ++_l : --_l) {
      triArea = 0;
      if (ia === ripb) {
        ib0 = ripb + 1;
      } else {
